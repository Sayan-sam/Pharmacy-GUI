...
public class ManageUsers {
	...
	{
		ManageUsers.adminusername = adminusername;
		int i;
		for(i = 1; i > 0; i++)
		{
		...
		Update.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				stock.dispose();
				new CreateUser(ManageUsers.adminusername);
			}
		...
		Delete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					stock.dispose();
					new ManageUsers(ManageUsers.adminusername);
				}
				catch(Exception ex)
				{
					ex.printStackTrace();
		...
		sidePic = new JLabel(new ImageIcon("pharmacygui/resources/images/User.png"));
		...
		home.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				stock.dispose();
				new LoggedInPage(ManageUsers.adminusername);
			}});
