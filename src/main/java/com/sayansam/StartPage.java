...
public class StartPage implements ActionListener{
	...
	StartPage()
	{
		heading = new JLabel(new ImageIcon("pharmacygui/resources/images/Welcome.png"));
		...
		startFrame.setIconImage(new ImageIcon("pharmacygui/resources/images/Pharmacy.png").getImage());
