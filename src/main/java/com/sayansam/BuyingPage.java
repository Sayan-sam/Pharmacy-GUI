...
public class BuyingPage {
	...
	BuyingPage(String username) throws Exception
	{
		...
		sidePic = new JLabel(new ImageIcon("pharmacygui/resources/images/Buying.png"));
		...
		confirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					int trancId = jm.initTranc(BuyingPage.username, "Company", "Buy");
...
;			}
		...
		home.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				billingPage.dispose();
				new LoggedInPage(BuyingPage.username);
			}});
	...
	public void updateMedicineRate() throws Exception
	{
		...
		final JLabel rate = new JLabel("Rate: 0");
		final JTextField newRate = new JTextField("Enter New Rate");
		String medName[] = new String[jm.getMedlen()+1];
		...
		Arrays.sort(medName, 1, jm.getMedlen());
		final JComboBox<?> medicines = new JComboBox<Object>(medName);	
	...
	public void addNewMed(String username)
	{
		...
		final JFrame frame = new JFrame("Add New Med");
		final JLabel lname = new JLabel("Enter Name:");
		final JLabel lprice = new JLabel("Enter Price: ");
		final JLabel lamount = new JLabel("Enter Amount: ");
		final JLabel ltype = new JLabel("Select Type:");
		final JLabel lclass = new JLabel("Select Class: ");
		final JLabel present = new JLabel("Medicine Already Present!!");
		
		final JTextField tfname = new JTextField("Enter Name");

		final JTextField tfprice = new JTextField("Enter Price");
		
		final JTextField tfamount = new JTextField("Enter Amount");
		
		final JComboBox<?> cbtype = new JComboBox<Object>(typeName);
		
		final JComboBox<?> cbclass = new JComboBox<Object>(className);
		
		
		final JLabel lnamee = new JLabel("Field cannot be empty");
		final JLabel lpricee = new JLabel("Field cannot be empty");
		final JLabel lamounte = new JLabel("Field cannot be empty");
		final JLabel ltypee = new JLabel("Field cannot be empty");
		final JLabel lclasse = new JLabel("Field cannot be empty");
		...
		proceed.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					System.out.println(BuyingPage.username);
					try {
						...
						billingPage.dispose();
						frame.dispose();
						new BuyingPage(BuyingPage.username);
						} catch (NumberFormatException e1) {
						e1.printStackTrace();
