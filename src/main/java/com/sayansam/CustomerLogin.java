...
public class CustomerLogin {
	...
	CustomerLogin(String username)
	{
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(jm.customerCheck(tfphNum.getText()))
					{
						...
						new BillingPage(CustomerLogin.username,tfphNum.getText());
		...
		signup.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				new CustomerSignup(CustomerLogin.username, tfphNum.getText());
				customerLogin.dispose();
			}});
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				customerLogin.dispose();
				try {
					new LoggedInPage(CustomerLogin.username);
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		customerLogin.setIconImage(new ImageIcon("pharmacygui/resources/images/Pharmacy.png").getImage());
